...
5. Fusionner la branche de release dans `main` et taguer le commit de fusion `X.Y.Z`.
...
4. Fusionner la branche hotfix dans `main` et taguer le commit de fusion `X.Y.Z`.
