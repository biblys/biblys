...
4. Fusionner la branche de release dans `main` et taguer le commit de fusion `X.Y.Z`.
5. Fusionner `main` dans `dev` et ajouter une nouvelle section `## <prochaine-version> (DEV)` en haut de `CHANGELOG.md`.
...
3. Fusionner la branche hotfix dans `main` et taguer le commit de fusion `X.Y.Z`.
4. Fusionner `main` dans `dev`.
