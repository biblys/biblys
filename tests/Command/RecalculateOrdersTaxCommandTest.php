...
class RecalculateOrdersTaxCommandTest extends TestCase
{
    ...
    {
        // Instance pooling is disabled process-wide by Propel::disableInstancePooling(),
        // so it must be restored or every later test in the same PHPUnit run is affected.
