 ...
 * up to version 1781846261.
 * Generated on 2026-06-19 05:17:41 by clement */
class PropelMigration_1781846261{
    /**
     * @var string
     */
    public $comment = '';
...
ALTER TABLE `payments`
  ...
  ADD `payment_refunded_at` TIMESTAMP NULL AFTER `payment_updated`,

  ADD `payment_original_id` INTEGER AFTER `payment_refunded_at`;

CREATE INDEX `payments_fi_188bd2` ON `payments` (`payment_original_id`);
...
DROP INDEX `payments_fi_188bd2` ON `payments`;

ALTER TABLE `payments`

  CHANGE `payment_id` `payment_id` int(10) unsigned NOT NULL AUTO_INCREMENT,

  DROP `payment_refunded_at`,

  DROP `payment_original_id`;
