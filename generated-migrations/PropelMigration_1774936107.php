 ...
 * up to version 1774936107.
 * Generated on 2026-03-31 05:48:27 by clement */
class PropelMigration_1774936107{
    /**
     * @var string
     */
    public $comment = '';
...
ALTER TABLE `articles`
  ...
  CHANGE `article_noosfere_id` `article_noosfere_id` INTEGER,

  CHANGE `type_id` `type_id` TINYINT,
  ...
  CHANGE `collection_id` `collection_id` INTEGER,
...
ALTER TABLE `invitations`
  ...
  CHANGE `site_id` `site_id` int unsigned NOT NULL;
...
ALTER TABLE `people`
  ...
  CHANGE `people_birth` `people_birth` INTEGER,

  CHANGE `people_death` `people_death` INTEGER,
...
ALTER TABLE `posts`
  ...
  CHANGE `post_illustration_version` `post_illustration_version` INTEGER DEFAULT 0,
...
ALTER TABLE `rayons`
  ...
  CHANGE `rayon_order` `rayon_order` TINYINT,
...
ALTER TABLE `special_offers`
  ...
  CHANGE `free_article_id` `free_article_id` INTEGER NOT NULL;
...
ALTER TABLE `stock`
  ...
  CHANGE `axys_account_id` `axys_account_id` INTEGER,
...
ALTER TABLE `subscriptions`
  ...
  CHANGE `subscription_ends` `subscription_ends` SMALLINT;
...
ALTER TABLE `alerts`
  ...
  CHANGE `alert_pub_year` `alert_pub_year` int(4) unsigned;

ALTER TABLE `articles`

  CHANGE `article_id` `article_id` int(11) unsigned NOT NULL AUTO_INCREMENT,

  CHANGE `article_ean` `article_ean` bigint(13) unsigned,

  CHANGE `article_noosfere_id` `article_noosfere_id` INTEGER(10),

  CHANGE `type_id` `type_id` TINYINT(11),
  ...
  CHANGE `collection_id` `collection_id` INTEGER(10),
  ...
  CHANGE `article_pdf_ean` `article_pdf_ean` bigint(13) unsigned,

  CHANGE `article_epub_ean` `article_epub_ean` bigint(13) unsigned,

  CHANGE `article_azw_ean` `article_azw_ean` bigint(13) unsigned,

  CHANGE `article_copyright` `article_copyright` mediumint(4) unsigned,
...
ALTER TABLE `authentication_methods`
  ...
  CHANGE `site_id` `site_id` INTEGER(10) NOT NULL,

  CHANGE `user_id` `user_id` INTEGER(10) NOT NULL;
...
ALTER TABLE `collections`
  ...
  CHANGE `collection_id` `collection_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `cron_jobs`
  ...
  CHANGE `cron_job_id` `cron_job_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `cycles`
  ...
  CHANGE `cycle_id` `cycle_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `files`
  ...
  CHANGE `file_ean` `file_ean` bigint(13) unsigned;
...
ALTER TABLE `inventory`
  ...
  CHANGE `inventory_id` `inventory_id` int(11) unsigned NOT NULL AUTO_INCREMENT,

  CHANGE `site_id` `site_id` int(11) unsigned;

ALTER TABLE `inventory_item`

  CHANGE `ii_id` `ii_id` int(11) unsigned NOT NULL AUTO_INCREMENT,

  CHANGE `inventory_id` `inventory_id` int(11) unsigned,

  CHANGE `ii_quantity` `ii_quantity` int(11) unsigned,

  CHANGE `ii_stock` `ii_stock` int(11) unsigned;
...
ALTER TABLE `links`
  ...
  CHANGE `event_id` `event_id` int(11) unsigned,

  CHANGE `post_id` `post_id` int(11) unsigned,
...
ALTER TABLE `options`
  ...
  CHANGE `option_id` `option_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `orders`
  ...
  CHANGE `axys_account_id` `axys_account_id` int(11) unsigned,
  ...
  CHANGE `order_payment_payplug` `order_payment_payplug` int(11) unsigned DEFAULT 0,
...
ALTER TABLE `payments`
  ...
  CHANGE `payment_id` `payment_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `people`
  ...
  CHANGE `people_birth` `people_birth` INTEGER(4),

  CHANGE `people_death` `people_death` INTEGER(4),
...
ALTER TABLE `posts`
  ...
  CHANGE `post_illustration_version` `post_illustration_version` INTEGER(3) DEFAULT 0,
...
ALTER TABLE `publishers`
  ...
  CHANGE `publisher_id` `publisher_id` int(11) unsigned NOT NULL AUTO_INCREMENT,

  CHANGE `site_id` `site_id` int(10) unsigned,

  CHANGE `publisher_shipping_fee` `publisher_shipping_fee` int(10) unsigned,

  CHANGE `publisher_gln` `publisher_gln` bigint(13) unsigned;

ALTER TABLE `rayons`

  CHANGE `rayon_id` `rayon_id` bigint(4) unsigned NOT NULL AUTO_INCREMENT,

  CHANGE `site_id` `site_id` int(10) unsigned,

  CHANGE `rayon_order` `rayon_order` TINYINT(2),

  CHANGE `rayon_show_upcoming` `rayon_show_upcoming` tinyint(1) unsigned DEFAULT 0;
...
ALTER TABLE `roles`
  ...
  CHANGE `role_hide` `role_hide` tinyint(1) unsigned;

ALTER TABLE `session`

  CHANGE `session_id` `session_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `shipping`
  ...
  CHANGE `shipping_max_weight` `shipping_max_weight` int(11) unsigned,

  CHANGE `shipping_max_articles` `shipping_max_articles` int(10) unsigned,

  CHANGE `shipping_max_amount` `shipping_max_amount` int(11) unsigned;

ALTER TABLE `signings`

  CHANGE `signing_id` `signing_id` int(11) unsigned NOT NULL AUTO_INCREMENT,

  CHANGE `site_id` `site_id` int(11) unsigned,

  CHANGE `publisher_id` `publisher_id` int(10) unsigned,

  CHANGE `people_id` `people_id` int(11) unsigned;
...
ALTER TABLE `sites`
  ...
  CHANGE `site_event_date` `site_event_date` int(11) unsigned,
...
ALTER TABLE `special_offers`
  ...
  CHANGE `target_collection_id` `target_collection_id` INTEGER(10) NOT NULL,

  CHANGE `target_quantity` `target_quantity` INTEGER(10) NOT NULL,

  CHANGE `free_article_id` `free_article_id` INTEGER(10) NOT NULL;
...
ALTER TABLE `stock`
  ...
  CHANGE `axys_account_id` `axys_account_id` INTEGER(10),
  ...
  CHANGE `stock_pub_year` `stock_pub_year` int(4) unsigned,

  CHANGE `stock_photo_version` `stock_photo_version` int(10) unsigned DEFAULT 0;

ALTER TABLE `subscriptions`

  CHANGE `subscription_id` `subscription_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  CHANGE `subscription_ends` `subscription_ends` SMALLINT(16);
...
ALTER TABLE `wishlist`
  ...
  CHANGE `wishlist_id` `wishlist_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
