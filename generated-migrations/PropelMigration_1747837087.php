...
SELECT 
    country_id,
    CASE 
        WHEN shipping_zone = 'F' THEN 1
        WHEN shipping_zone = 'A' THEN 2
        WHEN shipping_zone = 'B' THEN 3
        WHEN shipping_zone = 'C' THEN 4
        WHEN shipping_zone = 'OM1' THEN 5
        WHEN shipping_zone = 'OM2' THEN 6
        ELSE NULL
    END AS shipping_zone_id
FROM countries;

UPDATE shipping SET shipping_zone_id = 1 WHERE shipping_zone = 'F';
UPDATE shipping SET shipping_zone_id = 2 WHERE shipping_zone = 'A';
UPDATE shipping SET shipping_zone_id = 3 WHERE shipping_zone = 'B';
UPDATE shipping SET shipping_zone_id = 4 WHERE shipping_zone = 'C';
UPDATE shipping SET shipping_zone_id = 5 WHERE shipping_zone = 'OM1';
UPDATE shipping SET shipping_zone_id = 6 WHERE shipping_zone = 'OM2';
EOT;
