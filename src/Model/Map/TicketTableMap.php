...
class TicketTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.TicketTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Ticket';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Ticket';
     ...
     */
    const COL_TICKET_ID = 'ticket.ticket_id';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'ticket.user_id';

    /**
     * the column name for the site_id field
     */
    const COL_SITE_ID = 'ticket.site_id';

    /**
     * the column name for the ticket_type field
     */
    const COL_TICKET_TYPE = 'ticket.ticket_type';

    /**
     * the column name for the ticket_title field
     */
    const COL_TICKET_TITLE = 'ticket.ticket_title';

    /**
     * the column name for the ticket_content field
     */
    const COL_TICKET_CONTENT = 'ticket.ticket_content';

    /**
     * the column name for the ticket_priority field
     */
    const COL_TICKET_PRIORITY = 'ticket.ticket_priority';

    /**
     * the column name for the ticket_created field
     */
    const COL_TICKET_CREATED = 'ticket.ticket_created';

    /**
     * the column name for the ticket_updated field
     */
    const COL_TICKET_UPDATED = 'ticket.ticket_updated';

    /**
     * the column name for the ticket_resolved field
     */
    const COL_TICKET_RESOLVED = 'ticket.ticket_resolved';
    ...
    {
        return array(
            'timestampable' => array('create_column' => 'ticket_created', 'update_column' => 'ticket_updated', 'disable_created_at' => 'false', 'disable_updated_at' => 'false', ),
        );
    } // getBehaviors()
