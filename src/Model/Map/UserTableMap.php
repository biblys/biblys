...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Password', 'Key', 'EmailKey', 'FacebookUid', 'ScreenName', 'Slug', 'WishlistShip', 'Top', 'Biblio', 'AdresseIp', 'RecaptchaScore', 'Dateinscription', 'Dateconnexion', 'PublisherId', 'BookshopId', 'LibraryId', 'Civilite', 'Nom', 'Prenom', 'Adresse1', 'Adresse2', 'Codepostal', 'Ville', 'Pays', 'Telephone', 'PrefArticlesShow', 'FbId', 'FbToken', 'CountryId', 'PasswordResetToken', 'PasswordResetTokenCreated', 'Update', 'CreatedAt', 'UpdatedAt', 'DeletedAt', 'DeletedWhy', ),
    ...
    protected $normalizedColumnNameMap = [
        ...
        'User.ScreenName' => 'USER_SCREEN_NAME',
        'screenName' => 'USER_SCREEN_NAME',
        'user.screenName' => 'USER_SCREEN_NAME',
    ...
    public function initialize()
    {
        ...
        $this->addColumn('user_screen_name', 'ScreenName', 'VARCHAR', false, 128, null);
