...
class SessionTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'SiteId', 'AxysAccountId', 'Token', 'CreatedAt', 'ExpiresAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['id', 'siteId', 'axysAccountId', 'token', 'createdAt', 'expiresAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SessionTableMap::COL_SESSION_ID, SessionTableMap::COL_SITE_ID, SessionTableMap::COL_AXYS_ACCOUNT_ID, SessionTableMap::COL_SESSION_TOKEN, SessionTableMap::COL_SESSION_CREATED, SessionTableMap::COL_SESSION_EXPIRES, SessionTableMap::COL_SESSION_UPDATED, ],
        self::TYPE_FIELDNAME     => ['session_id', 'site_id', 'axys_account_id', 'session_token', 'session_created', 'session_expires', 'session_updated', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'SiteId' => 1, 'AxysAccountId' => 2, 'Token' => 3, 'CreatedAt' => 4, 'ExpiresAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'siteId' => 1, 'axysAccountId' => 2, 'token' => 3, 'createdAt' => 4, 'expiresAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SessionTableMap::COL_SESSION_ID => 0, SessionTableMap::COL_SITE_ID => 1, SessionTableMap::COL_AXYS_ACCOUNT_ID => 2, SessionTableMap::COL_SESSION_TOKEN => 3, SessionTableMap::COL_SESSION_CREATED => 4, SessionTableMap::COL_SESSION_EXPIRES => 5, SessionTableMap::COL_SESSION_UPDATED => 6, ],
        self::TYPE_FIELDNAME     => ['session_id' => 0, 'site_id' => 1, 'axys_account_id' => 2, 'session_token' => 3, 'session_created' => 4, 'session_expires' => 5, 'session_updated' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
