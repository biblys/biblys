...
class JobTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.JobTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Job';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Job';
