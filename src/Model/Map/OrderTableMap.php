...
class OrderTableMap extends TableMap
{
     ...
     */
    const COL_AS_A_GIFT = 'orders.order_as_a_gift';

    /**
     * the column name for the order_gift_recipient field
     */
    const COL_GIFT_RECIPIENT = 'orders.order_gift_recipient';
