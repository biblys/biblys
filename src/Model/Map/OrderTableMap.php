...
class OrderTableMap extends TableMap
{
     ...
     */
    public const COL_AXYS_USER_ID = 'orders.axys_user_id';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'Order.AxysUserId' => 'AXYS_USER_ID',
        'axysUserId' => 'AXYS_USER_ID',
        'order.axysUserId' => 'AXYS_USER_ID',
        'OrderTableMap::COL_AXYS_USER_ID' => 'AXYS_USER_ID',
        'COL_AXYS_USER_ID' => 'AXYS_USER_ID',
        'axys_user_id' => 'AXYS_USER_ID',
        'orders.axys_user_id' => 'AXYS_USER_ID',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderTableMap::COL_AXYS_USER_ID);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(OrderTableMap::COL_AXYS_USER_ID);
