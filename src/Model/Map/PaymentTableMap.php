...
class PaymentTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Model.Map.PaymentTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'Model.Payment';
     ...
     */
    public const COL_PAYMENT_ID = 'payments.payment_id';

    /**
     * the column name for the site_id field
     */
    public const COL_SITE_ID = 'payments.site_id';

    /**
     * the column name for the order_id field
     */
    public const COL_ORDER_ID = 'payments.order_id';

    /**
     * the column name for the payment_amount field
     */
    public const COL_PAYMENT_AMOUNT = 'payments.payment_amount';

    /**
     * the column name for the payment_mode field
     */
    public const COL_PAYMENT_MODE = 'payments.payment_mode';

    /**
     * the column name for the payment_provider_id field
     */
    public const COL_PAYMENT_PROVIDER_ID = 'payments.payment_provider_id';

    /**
     * the column name for the payment_url field
     */
    public const COL_PAYMENT_URL = 'payments.payment_url';

    /**
     * the column name for the payment_created field
     */
    public const COL_PAYMENT_CREATED = 'payments.payment_created';

    /**
     * the column name for the payment_executed field
     */
    public const COL_PAYMENT_EXECUTED = 'payments.payment_executed';
