...
class VoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.VoteTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Vote';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Vote';
     ...
     */
    const COL_VOTE_ID = 'votes.vote_id';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'votes.user_id';

    /**
     * the column name for the vote_F field
     */
    const COL_VOTE_F = 'votes.vote_F';

    /**
     * the column name for the vote_E field
     */
    const COL_VOTE_E = 'votes.vote_E';

    /**
     * the column name for the vote_date field
     */
    const COL_VOTE_DATE = 'votes.vote_date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'F', 'E', 'Date', ),
        self::TYPE_CAMELNAME     => array('id', 'userId', 'f', 'e', 'date', ),
        self::TYPE_COLNAME       => array(VoteTableMap::COL_VOTE_ID, VoteTableMap::COL_USER_ID, VoteTableMap::COL_VOTE_F, VoteTableMap::COL_VOTE_E, VoteTableMap::COL_VOTE_DATE, ),
        self::TYPE_FIELDNAME     => array('vote_id', 'user_id', 'vote_F', 'vote_E', 'vote_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'UserId' => 1, 'F' => 2, 'E' => 3, 'Date' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userId' => 1, 'f' => 2, 'e' => 3, 'date' => 4, ),
        self::TYPE_COLNAME       => array(VoteTableMap::COL_VOTE_ID => 0, VoteTableMap::COL_USER_ID => 1, VoteTableMap::COL_VOTE_F => 2, VoteTableMap::COL_VOTE_E => 3, VoteTableMap::COL_VOTE_DATE => 4, ),
        self::TYPE_FIELDNAME     => array('vote_id' => 0, 'user_id' => 1, 'vote_F' => 2, 'vote_E' => 3, 'vote_date' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
