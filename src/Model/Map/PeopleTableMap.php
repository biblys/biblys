...
class PeopleTableMap extends TableMap
{
    ...
    public function initialize(): void
    {
        ...
        // columns
        $this->addPrimaryKey('people_id', 'Id', 'INTEGER', true, null, null);
        ...
        $this->addColumn('people_pseudo', 'Pseudo', 'INTEGER', false, null, null);
        $this->addColumn('people_noosfere_id', 'NoosfereId', 'INTEGER', false, null, null);
        $this->addColumn('people_birth', 'Birth', 'INTEGER', false, null, null);
        $this->addColumn('people_death', 'Death', 'INTEGER', false, null, null);
        ...
        $this->addColumn('people_hits', 'Hits', 'INTEGER', false, null, null);
