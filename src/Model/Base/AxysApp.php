...
abstract class AxysApp implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\AxysAppTableMap';
     ...
     * @return $this|\Model\AxysApp The current object (for fluent API support)
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\AxysApp The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildAxysApp The current object (for fluent API support)
     */
