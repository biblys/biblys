...
abstract class CouponQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT coupon_id, site_id, user_id, coupon_code, article_id, stock_id, coupon_amount, coupon_note, coupon_used, coupon_creator, coupon_insert, coupon_update FROM coupons WHERE coupon_id = :p0';
        try {
