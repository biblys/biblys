...
abstract class Link implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\LinkTableMap';
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LinkTableMap::COL_TAG_ID)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Link The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LinkTableMap::COL_TAG_ID)) {
            $criteria->add(LinkTableMap::COL_TAG_ID, $this->tag_id);
        }
        if ($this->isColumnModified(LinkTableMap::COL_EVENT_ID)) {
     ...
     *
     * @return     $this|ChildLink The current object (for fluent API support)
     */
