...
abstract class Session implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Model\\Map\\SessionTableMap';
    ...
    /**
     * The value for the session_created field.
     *
     * @var        DateTime|null
     */
    protected $session_created;

    /**
     * The value for the session_expires field.
     *
     * @var        DateTime|null
     */
    ...
    /**
     * The value for the session_updated field.
     *
     * @var        DateTime|null
     */
    ...
    /**
     * Initializes internal state of Model\Base\Session object.
     */
    ...
    /**
     * Get the [optionally formatted] temporal [session_created] column value.
     *
     *
    ...
    public function getCreatedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->session_created instanceof \DateTimeInterface ? $this->session_created->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [session_expires] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getExpiresAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->session_expires instanceof \DateTimeInterface ? $this->session_expires->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [session_updated] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getUpdatedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->session_updated instanceof \DateTimeInterface ? $this->session_updated->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->session_id !== $v) {
            $this->session_id = $v;
            $this->modifiedColumns[SessionTableMap::COL_SESSION_ID] = true;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->session_token !== $v) {
            ...
            $this->modifiedColumns[SessionTableMap::COL_SESSION_TOKEN] = true;
        }
    ...
    /**
     * Sets the value of [session_created] column to a normalized version of the date/time value specified.
     *
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->session_created !== null || $dt !== null) {
            if ($this->session_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->session_created->format("Y-m-d H:i:s.u")) {
                $this->session_created = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SessionTableMap::COL_SESSION_CREATED] = true;
            }
    ...
    /**
     * Sets the value of [session_expires] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->session_expires !== null || $dt !== null) {
            if ($this->session_expires === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->session_expires->format("Y-m-d H:i:s.u")) {
                $this->session_expires = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SessionTableMap::COL_SESSION_EXPIRES] = true;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of [session_updated] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->session_updated !== null || $dt !== null) {
            if ($this->session_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->session_updated->format("Y-m-d H:i:s.u")) {
                $this->session_updated = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SessionTableMap::COL_SESSION_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SessionTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SessionTableMap::translateFieldName('Token', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SessionTableMap::translateFieldName('ExpiresAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->session_expires = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SessionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = SessionTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SessionTableMap::COL_SESSION_CREATED)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SessionTableMap::COL_SESSION_UPDATED)) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_SESSION_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'session_created';
        }
        if ($this->isColumnModified(SessionTableMap::COL_SESSION_EXPIRES)) {
            $modifiedColumns[':p' . $index++]  = 'session_expires';
        }
        if ($this->isColumnModified(SessionTableMap::COL_SESSION_UPDATED)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SessionTableMap::COL_SESSION_CREATED)) {
            $criteria->add(SessionTableMap::COL_SESSION_CREATED, $this->session_created);
        }
        if ($this->isColumnModified(SessionTableMap::COL_SESSION_EXPIRES)) {
            $criteria->add(SessionTableMap::COL_SESSION_EXPIRES, $this->session_expires);
        }
        if ($this->isColumnModified(SessionTableMap::COL_SESSION_UPDATED)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \Model\Session (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Session Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
