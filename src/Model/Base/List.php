...
abstract class List implements ActiveRecordInterface
{
    ...
    /**
     * The value for the list_deleted field.
     *
     * @var        DateTime|null
     */
    protected $list_deleted;
    ...
    /**
     * Get the [optionally formatted] temporal [list_deleted] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getDeletedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->list_deleted instanceof \DateTimeInterface ? $this->list_deleted->format($format) : null;
        }
    }
    ...
    /**
     * Sets the value of [list_deleted] column to a normalized version of the date/time value specified.
     *
     * @param  string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Model\List The current object (for fluent API support)
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->list_deleted = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'list_updated':
                        ...
                        break;
                    case 'list_deleted':
                        $stmt->bindValue($identifier, $this->list_deleted ? $this->list_deleted->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
