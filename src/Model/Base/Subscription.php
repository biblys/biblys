...
abstract class Subscription implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Model\\Map\\SubscriptionTableMap';
    ...
    /**
     * The value for the subscription_email field.
     *
     * @var        string|null
     */
    protected $subscription_email;

    /**
     * The value for the subscription_ends field.
     *
     * @var        int|null
     */
    protected $subscription_ends;

    /**
     * The value for the subscription_option field.
     *
     * Note: this column has a database default value of: false
     * @var        boolean|null
     */
    protected $subscription_option;

    /**
     * The value for the subscription_insert field.
     *
     * @var        DateTime|null
     */
    protected $subscription_insert;

    /**
     * The value for the subscription_update field.
     *
     * @var        DateTime|null
     */
    protected $subscription_update;

    /**
     * The value for the subscription_created field.
     *
     * @var        DateTime|null
     */
    protected $subscription_created;

    /**
     * The value for the subscription_updated field.
     *
     * @var        DateTime|null
     */
    ...
    {
        $this->subscription_option = false;
    }

    /**
     * Initializes internal state of Model\Base\Subscription object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [subscription_email] column value.
     *
     * @return string|null
     */
    ...
    /**
     * Get the [subscription_ends] column value.
     *
     * @return int|null
     */
    ...
    /**
     * Get the [subscription_option] column value.
     *
     * @return boolean|null
     */
    public function getOption()
    {
        return $this->subscription_option;
    }
    ...
    /**
     * Get the [optionally formatted] temporal [subscription_insert] column value.
     *
     *
    ...
    {
        if ($format === null) {
            return $this->subscription_insert;
        } else {
            return $this->subscription_insert instanceof \DateTimeInterface ? $this->subscription_insert->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [subscription_update] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getUpdate($format = null)
    {
        if ($format === null) {
            ...
            return $this->subscription_update instanceof \DateTimeInterface ? $this->subscription_update->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [subscription_created] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getCreatedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->subscription_created instanceof \DateTimeInterface ? $this->subscription_created->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [subscription_updated] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getUpdatedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->subscription_updated instanceof \DateTimeInterface ? $this->subscription_updated->format($format) : null;
        }
    }
    ...
    public function setSiteId($v)
    {
        ...
        if ($this->site_id !== $v) {
            $this->site_id = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_SITE_ID] = true;
        }
    ...
    public function setPublisherId($v)
    {
        ...
        if ($this->publisher_id !== $v) {
            $this->publisher_id = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_PUBLISHER_ID] = true;
        }
    ...
    /**
     * Set the value of [subscription_email] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setEmail($v)
    {
        ...
        if ($this->subscription_email !== $v) {
            $this->subscription_email = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_EMAIL] = true;
        }
    ...
    /**
     * Set the value of [subscription_ends] column.
     *
     * @param int|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setEnds($v)
    {
        ...
        if ($this->subscription_ends !== $v) {
            $this->subscription_ends = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_ENDS] = true;
        }
    ...
    /**
     * Sets the value of the [subscription_option] column.
    ...
    public function setOption($v)
    {
        ...
        if ($this->subscription_option !== $v) {
            $this->subscription_option = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_OPTION] = true;
        }
    ...
    /**
     * Sets the value of [subscription_insert] column to a normalized version of the date/time value specified.
     *
    ...
    public function setInsert($v)
    {
        ...
        if ($this->subscription_insert !== null || $dt !== null) {
            if ($this->subscription_insert === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->subscription_insert->format("Y-m-d H:i:s.u")) {
                $this->subscription_insert = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_INSERT] = true;
            }
    ...
    /**
     * Sets the value of [subscription_update] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->subscription_update !== null || $dt !== null) {
            if ($this->subscription_update === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->subscription_update->format("Y-m-d H:i:s.u")) {
                $this->subscription_update = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_UPDATE] = true;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of [subscription_created] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->subscription_created !== null || $dt !== null) {
            if ($this->subscription_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->subscription_created->format("Y-m-d H:i:s.u")) {
                $this->subscription_created = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_CREATED] = true;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of [subscription_updated] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->subscription_updated !== null || $dt !== null) {
            if ($this->subscription_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->subscription_updated->format("Y-m-d H:i:s.u")) {
                $this->subscription_updated = $dt === null ? null : clone $dt;
                $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_UPDATED] = true;
            }
        } // if either are not null
    ...
    {
            if ($this->subscription_option !== false) {
                return false;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SubscriptionTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subscription_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SubscriptionTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subscription_email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SubscriptionTableMap::translateFieldName('Ends', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subscription_ends = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SubscriptionTableMap::translateFieldName('Option', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subscription_option = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SubscriptionTableMap::translateFieldName('Insert', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->subscription_insert = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SubscriptionTableMap::translateFieldName('Update', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->subscription_update = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SubscriptionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->subscription_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SubscriptionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 13; // 13 = SubscriptionTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_CREATED)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_UPDATED)) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_email';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_ENDS)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_ends';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_OPTION)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_option';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_INSERT)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_insert';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_update';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_created';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_UPDATED)) {
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) {
            $this->setEnds($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setOption($arr[$keys[8]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_EMAIL)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_EMAIL, $this->subscription_email);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_ENDS)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_ENDS, $this->subscription_ends);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_OPTION)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_OPTION, $this->subscription_option);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_INSERT)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_INSERT, $this->subscription_insert);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_UPDATE)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_UPDATE, $this->subscription_update);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_CREATED)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_CREATED, $this->subscription_created);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_UPDATED)) {
    ...
    /**
     * Generic method to set the primary key (subscription_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of \Model\Subscription (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Subscription Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getSite(?ConnectionInterface $con = null)
    {
        if ($this->aSite === null && ($this->site_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSite->addSubscriptions($this);
             */
        }
    ...
    {
        if (null !== $this->aSite) {
            $this->aSite->removeSubscription($this);
        }
        if (null !== $this->aUser) {
        ...
        $this->subscription_email = null;
        $this->subscription_ends = null;
        $this->subscription_option = null;
        $this->subscription_insert = null;
