...
abstract class Permission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\PermissionTableMap';
    ...
    /**
     * The value for the permission_rank field.
     *
     * @var        string|null
     */
    protected $permission_rank;

    /**
     * The value for the permission_last field.
     *
     * @var        DateTime|null
     */
    protected $permission_last;

    /**
     * The value for the permission_date field.
     *
     * @var        DateTime|null
     */
    ...
    /**
     * Initializes internal state of Model\Base\Permission object.
     */
    ...
    /**
     * Get the [permission_rank] column value.
     *
     * @return string|null
     */
    public function getRank()
    {
        return $this->permission_rank;
    }

    /**
     * Get the [optionally formatted] temporal [permission_last] column value.
     *
     *
     ...
     */
    public function getLast($format = null)
    {
        if ($format === null) {
            return $this->permission_last;
        } else {
            return $this->permission_last instanceof \DateTimeInterface ? $this->permission_last->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [permission_date] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getDate($format = null)
    {
        if ($format === null) {
            ...
            return $this->permission_date instanceof \DateTimeInterface ? $this->permission_date->format($format) : null;
        }
    }
     ...
     * @return $this|\Model\Permission The current object (for fluent API support)
     */
    ...
    public function setSiteId($v)
    {
        ...
        if ($this->site_id !== $v) {
            $this->site_id = $v;
            $this->modifiedColumns[PermissionTableMap::COL_SITE_ID] = true;
        }
    ...
    /**
     * Set the value of [permission_rank] column.
     *
    ...
    public function setRank($v)
    {
        ...
        if ($this->permission_rank !== $v) {
            $this->permission_rank = $v;
            $this->modifiedColumns[PermissionTableMap::COL_PERMISSION_RANK] = true;
        }
    ...
    /**
     * Sets the value of [permission_last] column to a normalized version of the date/time value specified.
     *
    ...
    public function setLast($v)
    {
        ...
        if ($this->permission_last !== null || $dt !== null) {
            if ($this->permission_last === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->permission_last->format("Y-m-d H:i:s.u")) {
                $this->permission_last = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PermissionTableMap::COL_PERMISSION_LAST] = true;
            }
    ...
    /**
     * Sets the value of [permission_date] column to a normalized version of the date/time value specified.
     *
     * @param  string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Model\Permission The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->permission_date !== null || $dt !== null) {
            if ($this->permission_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->permission_date->format("Y-m-d H:i:s.u")) {
                $this->permission_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PermissionTableMap::COL_PERMISSION_DATE] = true;
            }
        } // if either are not null
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSION_RANK)) {
            $modifiedColumns[':p' . $index++]  = 'permission_rank';
        }
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSION_LAST)) {
            $modifiedColumns[':p' . $index++]  = 'permission_last';
        }
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSION_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'permission_date';
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Permission The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSION_RANK)) {
            $criteria->add(PermissionTableMap::COL_PERMISSION_RANK, $this->permission_rank);
        }
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSION_LAST)) {
            $criteria->add(PermissionTableMap::COL_PERMISSION_LAST, $this->permission_last);
        }
        if ($this->isColumnModified(PermissionTableMap::COL_PERMISSION_DATE)) {
            $criteria->add(PermissionTableMap::COL_PERMISSION_DATE, $this->permission_date);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Permission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Permission Clone of current object.
     * @throws PropelException
     */
