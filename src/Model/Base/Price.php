...
/**
 * Base class that represents a row from the 'prices' table.
 *
 *
 *
...
abstract class Price implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\PriceTableMap';
    ...
    /**
     * The value for the price_id field.
     *
     * @var        int
     */
    protected $price_id;
    ...
    /**
     * The value for the price_cat field.
     *
     * @var        string|null
     */
    protected $price_cat;
    ...
    /**
     * The value for the price_amount field.
     *
     * @var        int|null
     */
    ...
    /**
     * The value for the price_created field.
     *
     * @var        DateTime|null
     */
    protected $price_created;

    /**
     * The value for the price_updated field.
     *
     * @var        DateTime|null
     */
    ...
    /**
     * Initializes internal state of Model\Base\Price object.
     */
    ...
    /**
     * Get the [price_cat] column value.
     *
     * @return string|null
     */
    public function getCat()
    {
        return $this->price_cat;
    }

    /**
     * Get the [price_amount] column value.
     *
     * @return int|null
     */
    ...
    /**
     * Get the [optionally formatted] temporal [price_created] column value.
     *
     *
    ...
    public function getCreatedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->price_created instanceof \DateTimeInterface ? $this->price_created->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [price_updated] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    public function getUpdatedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->price_updated instanceof \DateTimeInterface ? $this->price_updated->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->price_id !== $v) {
            $this->price_id = $v;
            $this->modifiedColumns[PriceTableMap::COL_PRICE_ID] = true;
        }
    ...
    public function setgridId($v)
    {
        ...
        if ($this->pricegrid_id !== $v) {
            $this->pricegrid_id = $v;
            $this->modifiedColumns[PriceTableMap::COL_PRICEGRID_ID] = true;
        }
    ...
    /**
     * Set the value of [price_cat] column.
     *
    ...
    public function setCat($v)
    {
        ...
        if ($this->price_cat !== $v) {
            $this->price_cat = $v;
            $this->modifiedColumns[PriceTableMap::COL_PRICE_CAT] = true;
        }
    ...
    /**
     * Set the value of [price_amount] column.
     *
     * @param int|null $v New value
     * @return $this|\Model\Price The current object (for fluent API support)
     */
    public function setAmount($v)
    {
        ...
        if ($this->price_amount !== $v) {
            $this->price_amount = $v;
            $this->modifiedColumns[PriceTableMap::COL_PRICE_AMOUNT] = true;
        }
    ...
    /**
     * Sets the value of [price_created] column to a normalized version of the date/time value specified.
     *
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->price_created !== null || $dt !== null) {
            if ($this->price_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->price_created->format("Y-m-d H:i:s.u")) {
                $this->price_created = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PriceTableMap::COL_PRICE_CREATED] = true;
            }
    ...
    /**
     * Sets the value of [price_updated] column to a normalized version of the date/time value specified.
     *
     * @param  string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Model\Price The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->price_updated !== null || $dt !== null) {
            if ($this->price_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->price_updated->format("Y-m-d H:i:s.u")) {
                $this->price_updated = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PriceTableMap::COL_PRICE_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PriceTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PriceTableMap::translateFieldName('gridId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricegrid_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PriceTableMap::translateFieldName('Cat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_cat = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PriceTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PriceTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->price_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PriceTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PriceTableMap::COL_PRICE_CREATED)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PriceTableMap::COL_PRICE_UPDATED)) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'price_id';
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICEGRID_ID)) {
            $modifiedColumns[':p' . $index++]  = 'pricegrid_id';
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_CAT)) {
            $modifiedColumns[':p' . $index++]  = 'price_cat';
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'price_amount';
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'price_created';
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_UPDATED)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Price The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_ID)) {
            $criteria->add(PriceTableMap::COL_PRICE_ID, $this->price_id);
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICEGRID_ID)) {
            $criteria->add(PriceTableMap::COL_PRICEGRID_ID, $this->pricegrid_id);
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_CAT)) {
            $criteria->add(PriceTableMap::COL_PRICE_CAT, $this->price_cat);
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_AMOUNT)) {
            $criteria->add(PriceTableMap::COL_PRICE_AMOUNT, $this->price_amount);
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_CREATED)) {
            $criteria->add(PriceTableMap::COL_PRICE_CREATED, $this->price_created);
        }
        if ($this->isColumnModified(PriceTableMap::COL_PRICE_UPDATED)) {
    ...
    /**
     * Generic method to set the primary key (price_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Price (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Price Clone of current object.
     * @throws PropelException
     */
