...
/**
 * Base class that represents a row from the 'tags_articles' table.
 *
 *
 *
...
abstract class ArticleTag implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Model\\Map\\ArticleTagTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\ArticleTag object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArticleTagTableMap::translateFieldName('TagId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticleTagTableMap::translateFieldName('ArticleId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\ArticleTag'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO tags_articles (%s) VALUES (%s)',
    ...
    public function hashCode()
    {
        ...
        //relation tags_articles_fk_3fff59 to table articles
        ...
        //relation tags_articles_fk_48f1fc to table tags
    ...
    {
        return (null === $this->getTagId()) && (null === $this->getArticleId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Model\ArticleTag (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\ArticleTag Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
