...
abstract class Stock implements ActiveRecordInterface
{
    ...
    public function setAxysAccountId($v)
    {
        ...
        if ($this->axys_account_id !== $v) {
            ...
            $this->modifiedColumns[StockTableMap::COL_AXYS_ACCOUNT_ID] = true;
        }
     ...
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildCart|null The associated ChildCart object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getCart(?ConnectionInterface $con = null)
    {
        if ($this->aCart === null && ($this->cart_id != 0)) {
    ...
    public function setImages(Collection $images, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($imagesToDelete as $imageRemoved) {
            $imageRemoved->setStockItem(null);
        }
