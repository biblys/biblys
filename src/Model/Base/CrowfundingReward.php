...
abstract class CrowfundingReward implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\CrowfundingRewardTableMap';
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\CrowfundingReward
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\CrowfundingReward The current object, for fluid interface
     */
