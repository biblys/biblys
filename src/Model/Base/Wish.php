...
/**
 * Base class that represents a row from the 'wishes' table.
 *
 *
 *
 * @package    propel.generator.Model.Base
 */
abstract class Wish implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Model\\Map\\WishTableMap';
    ...
    /**
     * The value for the wish_created field.
     *
     * @var        DateTime|null
     */
    protected $wish_created;

    /**
     * The value for the wish_updated field.
     *
     * @var        DateTime|null
     */
    protected $wish_updated;

    /**
     * The value for the wish_bought field.
     *
     * @var        DateTime|null
     */
    ...
    /**
     * Initializes internal state of Model\Base\Wish object.
     */
    ...
    /**
     * Compares this with another <code>Wish</code> instance.  If
     * <code>obj</code> is an instance of <code>Wish</code>, delegates to
     * <code>equals(Wish)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [optionally formatted] temporal [wish_created] column value.
     *
     *
    ...
    {
        if ($format === null) {
            return $this->wish_created;
        } else {
            return $this->wish_created instanceof \DateTimeInterface ? $this->wish_created->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [wish_updated] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
    ...
    {
        if ($format === null) {
            return $this->wish_updated;
        } else {
            return $this->wish_updated instanceof \DateTimeInterface ? $this->wish_updated->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [wish_bought] column value.
     *
     *
     * @param string|null $format The date/time format string (either date()-style or strftime()-style).
     *   If format is NULL, then the raw DateTime object will be returned.
     ...
     * @psalm-return ($format is null ? DateTime|null : string|null)
     */
    public function getBought($format = null)
    {
        if ($format === null) {
            return $this->wish_bought;
        } else {
            return $this->wish_bought instanceof \DateTimeInterface ? $this->wish_bought->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->wish_id !== $v) {
            $this->wish_id = $v;
            $this->modifiedColumns[WishTableMap::COL_WISH_ID] = true;
        }
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setWishlistId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->wishlist_id !== $v) {
            $this->wishlist_id = $v;
            $this->modifiedColumns[WishTableMap::COL_WISHLIST_ID] = true;
        }
    ...
    public function setAxysUserId($v)
    {
        ...
        if ($this->axys_user_id !== $v) {
            $this->axys_user_id = $v;
            $this->modifiedColumns[WishTableMap::COL_AXYS_USER_ID] = true;
        }
    ...
    public function setSiteId($v)
    {
        ...
        if ($this->site_id !== $v) {
            $this->site_id = $v;
            $this->modifiedColumns[WishTableMap::COL_SITE_ID] = true;
        }
    ...
    public function setArticleId($v)
    {
        ...
        if ($this->article_id !== $v) {
            $this->article_id = $v;
            $this->modifiedColumns[WishTableMap::COL_ARTICLE_ID] = true;
        }
    ...
    /**
     * Sets the value of [wish_created] column to a normalized version of the date/time value specified.
     *
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->wish_created !== null || $dt !== null) {
            if ($this->wish_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->wish_created->format("Y-m-d H:i:s.u")) {
                $this->wish_created = $dt === null ? null : clone $dt;
                $this->modifiedColumns[WishTableMap::COL_WISH_CREATED] = true;
            }
    ...
    /**
     * Sets the value of [wish_updated] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->wish_updated !== null || $dt !== null) {
            if ($this->wish_updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->wish_updated->format("Y-m-d H:i:s.u")) {
                $this->wish_updated = $dt === null ? null : clone $dt;
                $this->modifiedColumns[WishTableMap::COL_WISH_UPDATED] = true;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of [wish_bought] column to a normalized version of the date/time value specified.
     *
     * @param string|integer|\DateTimeInterface|null $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this The current object (for fluent API support)
     */
    public function setBought($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->wish_bought !== null || $dt !== null) {
            if ($this->wish_bought === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->wish_bought->format("Y-m-d H:i:s.u")) {
                $this->wish_bought = $dt === null ? null : clone $dt;
                $this->modifiedColumns[WishTableMap::COL_WISH_BOUGHT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WishTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wish_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WishTableMap::translateFieldName('WishlistId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wishlist_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WishTableMap::translateFieldName('AxysUserId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildWishQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWishQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(WishTableMap::COL_WISH_CREATED)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(WishTableMap::COL_WISH_UPDATED)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(WishTableMap::COL_WISH_UPDATED)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WishTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = WishTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $alreadyDumpedObjects['Wish'][$this->hashCode()] = true;
        $keys = WishTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(WishTableMap::COL_WISH_ID)) {
            $criteria->add(WishTableMap::COL_WISH_ID, $this->wish_id);
        }
        if ($this->isColumnModified(WishTableMap::COL_WISHLIST_ID)) {
            $criteria->add(WishTableMap::COL_WISHLIST_ID, $this->wishlist_id);
        }
        if ($this->isColumnModified(WishTableMap::COL_AXYS_USER_ID)) {
            $criteria->add(WishTableMap::COL_AXYS_USER_ID, $this->axys_user_id);
        }
        if ($this->isColumnModified(WishTableMap::COL_SITE_ID)) {
            $criteria->add(WishTableMap::COL_SITE_ID, $this->site_id);
        }
        if ($this->isColumnModified(WishTableMap::COL_ARTICLE_ID)) {
            $criteria->add(WishTableMap::COL_ARTICLE_ID, $this->article_id);
        }
        if ($this->isColumnModified(WishTableMap::COL_WISH_CREATED)) {
            $criteria->add(WishTableMap::COL_WISH_CREATED, $this->wish_created);
        }
        if ($this->isColumnModified(WishTableMap::COL_WISH_UPDATED)) {
            $criteria->add(WishTableMap::COL_WISH_UPDATED, $this->wish_updated);
        }
        if ($this->isColumnModified(WishTableMap::COL_WISH_BOUGHT)) {
    ...
    {
        $criteria = ChildWishQuery::create();
        $criteria->add(WishTableMap::COL_WISH_ID, $this->wish_id);
    ...
    /**
     * Generic method to set the primary key (wish_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of \Model\Wish (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Wish Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if (null !== $this->aAxysUser) {
            $this->aAxysUser->removeWish($this);
        }
        $this->wish_id = null;
    ...
    {
        return (string) $this->exportTo(WishTableMap::DEFAULT_STRING_FORMAT);
    }
