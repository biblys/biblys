...
abstract class Wish implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\WishTableMap';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WishTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Wish The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildWish The current object (for fluent API support)
     */
