 ...
 *
 * @method     ChildSessionQuery leftJoinAxysUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the AxysUser relation
 * @method     ChildSessionQuery rightJoinAxysUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AxysUser relation
 * @method     ChildSessionQuery innerJoinAxysUser($relationAlias = null) Adds a INNER JOIN clause to the query using the AxysUser relation
 *
 * @method     ChildSessionQuery joinWithAxysUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AxysUser relation
 *
 * @method     ChildSessionQuery leftJoinWithAxysUser() Adds a LEFT JOIN clause and with to the query using the AxysUser relation
 * @method     ChildSessionQuery rightJoinWithAxysUser() Adds a RIGHT JOIN clause and with to the query using the AxysUser relation
 * @method     ChildSessionQuery innerJoinWithAxysUser() Adds a INNER JOIN clause and with to the query using the AxysUser relation
 *
 ...
 *
 * @method     \Model\AxysUserQuery|\Model\SiteQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SessionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT session_id, site_id, user_id, session_token, session_created, session_expires, session_updated FROM session WHERE session_id = :p0';
        try {
    ...
    public function filterByAxysUser($axysUser, ?string $comparison = null)
    {
        if ($axysUser instanceof \Model\AxysUser) {
            return $this
                ->addUsingAlias(SessionTableMap::COL_USER_ID, $axysUser->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(SessionTableMap::COL_USER_ID, $axysUser->toKeyValue('PrimaryKey', 'Id'), $comparison);
