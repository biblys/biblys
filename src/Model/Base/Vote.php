...
abstract class Vote implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\VoteTableMap';
     ...
     * @return $this|\Model\Vote The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VoteTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VoteTableMap::translateFieldName('E', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vote_e = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VoteTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Vote The current object, for fluid interface
     */
