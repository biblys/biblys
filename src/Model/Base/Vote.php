...
abstract class Vote implements ActiveRecordInterface
{
    ...
    /**
     * The value for the vote_e field.
     *
     * @var        int|null
     */
    protected $vote_e;
    ...
    /**
     * The value for the vote_date field.
     *
     * @var        DateTime|null
     */
    protected $vote_date;
    ...
    /**
     * Get the [optionally formatted] temporal [vote_date] column value.
     *
     *
    ...
    public function getDate($format = null)
    {
        if ($format === null) {
            ...
            return $this->vote_date instanceof \DateTimeInterface ? $this->vote_date->format($format) : null;
        }
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->vote_id !== $v) {
            $this->vote_id = $v;
            $this->modifiedColumns[VoteTableMap::COL_VOTE_ID] = true;
        }
    ...
    public function setSiteId($v)
    {
        ...
        if ($this->site_id !== $v) {
            $this->site_id = $v;
            $this->modifiedColumns[VoteTableMap::COL_SITE_ID] = true;
        }
    ...
    /**
     * Set the value of [vote_f] column.
     *
     * @param int|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setF($v)
    {
        ...
        if ($this->vote_f !== $v) {
            $this->vote_f = $v;
            $this->modifiedColumns[VoteTableMap::COL_VOTE_F] = true;
        }
    ...
    /**
     * Set the value of [vote_e] column.
     *
     * @param int|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setE($v)
    {
        ...
        if ($this->vote_e !== $v) {
            $this->vote_e = $v;
            $this->modifiedColumns[VoteTableMap::COL_VOTE_E] = true;
        }
    ...
    /**
     * Sets the value of [vote_date] column to a normalized version of the date/time value specified.
     *
    ...
    public function setDate($v)
    {
        ...
        if ($this->vote_date !== null || $dt !== null) {
            if ($this->vote_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->vote_date->format("Y-m-d H:i:s.u")) {
                $this->vote_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[VoteTableMap::COL_VOTE_DATE] = true;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VoteTableMap::translateFieldName('SiteId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->site_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VoteTableMap::translateFieldName('AxysAccountId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VoteTableMap::translateFieldName('F', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vote_f = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VoteTableMap::translateFieldName('E', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vote_e = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : VoteTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = VoteTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(VoteTableMap::COL_SITE_ID)) {
        ...
        if ($this->isColumnModified(VoteTableMap::COL_VOTE_E)) {
            $modifiedColumns[':p' . $index++]  = 'vote_E';
        }
        if ($this->isColumnModified(VoteTableMap::COL_VOTE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'vote_date';
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(VoteTableMap::COL_SITE_ID)) {
            $criteria->add(VoteTableMap::COL_SITE_ID, $this->site_id);
        }
        if ($this->isColumnModified(VoteTableMap::COL_AXYS_ACCOUNT_ID)) {
        ...
        if ($this->isColumnModified(VoteTableMap::COL_VOTE_E)) {
            $criteria->add(VoteTableMap::COL_VOTE_E, $this->vote_e);
        }
        if ($this->isColumnModified(VoteTableMap::COL_VOTE_DATE)) {
            $criteria->add(VoteTableMap::COL_VOTE_DATE, $this->vote_date);
        }
    ...
    /**
     * Generic method to set the primary key (vote_id column).
     *
