 ...
 * @method     ChildCartQuery orderBySellerUserId($order = Criteria::ASC) Order by the seller_user_id column
 ...
 * @method     ChildCartQuery groupBySellerUserId() Group by the seller_user_id column
 ...
 *
 * @method     ChildCartQuery leftJoinSellerUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the SellerUser relation
 * @method     ChildCartQuery rightJoinSellerUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SellerUser relation
 * @method     ChildCartQuery innerJoinSellerUser($relationAlias = null) Adds a INNER JOIN clause to the query using the SellerUser relation
 *
 * @method     ChildCartQuery joinWithSellerUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SellerUser relation
 *
 * @method     ChildCartQuery leftJoinWithSellerUser() Adds a LEFT JOIN clause and with to the query using the SellerUser relation
 * @method     ChildCartQuery rightJoinWithSellerUser() Adds a RIGHT JOIN clause and with to the query using the SellerUser relation
 * @method     ChildCartQuery innerJoinWithSellerUser() Adds a INNER JOIN clause and with to the query using the SellerUser relation
 *
 ...
 *
 * @method     \Model\UserQuery|\Model\UserQuery|\Model\SiteQuery|\Model\AxysAccountQuery|\Model\StockQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildCart|null findOneBySellerUserId(int $seller_user_id) Return the first ChildCart filtered by the seller_user_id column
 ...
 * @method     ChildCart requireOneBySellerUserId(int $seller_user_id) Return the first ChildCart filtered by the seller_user_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCart[]|Collection findBySellerUserId(int|array<int> $seller_user_id) Return ChildCart objects filtered by the seller_user_id column
 * @psalm-method Collection&\Traversable<ChildCart> findBySellerUserId(int|array<int> $seller_user_id) Return ChildCart objects filtered by the seller_user_id column
...
abstract class CartQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT cart_id, cart_uid, site_id, axys_account_id, user_id, seller_user_id, cart_seller_id, customer_id, cart_title, cart_type, cart_ip, cart_count, cart_amount, cart_as_a_gift, cart_gift_recipient, cart_date, cart_insert, cart_update, cart_created, cart_updated FROM carts WHERE cart_id = :p0';
        try {
    ...
    /**
     * Filter the query on the seller_user_id column
     *
     * Example usage:
     * <code>
     * $query->filterBySellerUserId(1234); // WHERE seller_user_id = 1234
     * $query->filterBySellerUserId(array(12, 34)); // WHERE seller_user_id IN (12, 34)
     * $query->filterBySellerUserId(array('min' => 12)); // WHERE seller_user_id > 12
     * </code>
     *
     * @see       filterBySellerUser()
     *
     * @param mixed $sellerUserId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySellerUserId($sellerUserId = null, ?string $comparison = null)
    {
        if (is_array($sellerUserId)) {
            $useMinMax = false;
            if (isset($sellerUserId['min'])) {
                $this->addUsingAlias(CartTableMap::COL_SELLER_USER_ID, $sellerUserId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($sellerUserId['max'])) {
                $this->addUsingAlias(CartTableMap::COL_SELLER_USER_ID, $sellerUserId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(CartTableMap::COL_SELLER_USER_ID, $sellerUserId, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySellerUser($user, ?string $comparison = null)
    {
        if ($user instanceof \Model\User) {
            return $this
                ->addUsingAlias(CartTableMap::COL_SELLER_USER_ID, $user->getId(), $comparison);
        } elseif ($user instanceof ObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            $this
                ->addUsingAlias(CartTableMap::COL_SELLER_USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);

            return $this;
        } else {
            throw new PropelException('filterBySellerUser() only accepts arguments of type \Model\User or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the SellerUser relation
     *
     * @param string|null $relationAlias Optional alias for the relation
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this The current query, for fluid interface
     */
    public function joinSellerUser(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('SellerUser');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'SellerUser');
        }
    ...
    /**
     * Use the SellerUser relation User object
     *
     * @see useQuery()
     *
     * @param string $relationAlias optional alias for the relation,
     ...
     * @return \Model\UserQuery A secondary query class using the current class as primary query
     */
    public function useSellerUserQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinSellerUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SellerUser', '\Model\UserQuery');
    }
     ...
     * @return $this
     */
    public function withSellerUserQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::LEFT_JOIN
    ) {
        $relatedQuery = $this->useSellerUserQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the SellerUser relation to the User table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \Model\UserQuery The inner query object of the EXISTS statement
     */
    public function useSellerUserExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \Model\UserQuery */
        $q = $this->useExistsQuery('SellerUser', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the SellerUser relation to the User table for a NOT EXISTS query.
     *
     * @see useSellerUserExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Model\UserQuery The inner query object of the NOT EXISTS statement
     */
    public function useSellerUserNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Model\UserQuery */
        $q = $this->useExistsQuery('SellerUser', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the SellerUser relation to the User table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \Model\UserQuery The inner query object of the IN statement
     */
    public function useInSellerUserQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Model\UserQuery */
        $q = $this->useInQuery('SellerUser', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the SellerUser relation to the User table for a NOT IN query.
     *
     * @see useSellerUserInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Model\UserQuery The inner query object of the NOT IN statement
     */
    public function useNotInSellerUserQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Model\UserQuery */
        $q = $this->useInQuery('SellerUser', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
