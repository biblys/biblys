 ...
 *
 * @method     ChildCartQuery leftJoinAxysUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the AxysUser relation
 * @method     ChildCartQuery rightJoinAxysUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AxysUser relation
 * @method     ChildCartQuery innerJoinAxysUser($relationAlias = null) Adds a INNER JOIN clause to the query using the AxysUser relation
 *
 * @method     ChildCartQuery joinWithAxysUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AxysUser relation
 *
 * @method     ChildCartQuery leftJoinWithAxysUser() Adds a LEFT JOIN clause and with to the query using the AxysUser relation
 * @method     ChildCartQuery rightJoinWithAxysUser() Adds a RIGHT JOIN clause and with to the query using the AxysUser relation
 * @method     ChildCartQuery innerJoinWithAxysUser() Adds a INNER JOIN clause and with to the query using the AxysUser relation
 *
 * @method     \Model\SiteQuery|\Model\AxysUserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CartQuery extends ModelCriteria
{
    ...
    public function filterByAxysUser($axysUser, ?string $comparison = null)
    {
        if ($axysUser instanceof \Model\AxysUser) {
            return $this
                ->addUsingAlias(CartTableMap::COL_AXYS_USER_ID, $axysUser->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(CartTableMap::COL_AXYS_USER_ID, $axysUser->toKeyValue('PrimaryKey', 'Id'), $comparison);
