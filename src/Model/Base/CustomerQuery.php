 ...
 *
 * @method     ChildCustomerQuery leftJoinSite($relationAlias = null) Adds a LEFT JOIN clause to the query using the Site relation
 * @method     ChildCustomerQuery rightJoinSite($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Site relation
 * @method     ChildCustomerQuery innerJoinSite($relationAlias = null) Adds a INNER JOIN clause to the query using the Site relation
 *
 * @method     ChildCustomerQuery joinWithSite($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Site relation
 *
 * @method     ChildCustomerQuery leftJoinWithSite() Adds a LEFT JOIN clause and with to the query using the Site relation
 * @method     ChildCustomerQuery rightJoinWithSite() Adds a RIGHT JOIN clause and with to the query using the Site relation
 * @method     ChildCustomerQuery innerJoinWithSite() Adds a INNER JOIN clause and with to the query using the Site relation
 *
 * @method     ChildCustomerQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildCustomerQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildCustomerQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 * @method     ChildCustomerQuery joinWithUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the User relation
 *
 * @method     ChildCustomerQuery leftJoinWithUser() Adds a LEFT JOIN clause and with to the query using the User relation
...
abstract class CustomerQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT customer_id, site_id, axys_account_id, user_id, customer_type, customer_first_name, customer_last_name, customer_email, customer_phone, country_id, customer_privatization, customer_insert, customer_update, customer_created, customer_updated FROM customers WHERE customer_id = :p0';
        try {
    ...
    public function filterBySite($site, ?string $comparison = null)
    {
        if ($site instanceof \Model\Site) {
            return $this
                ->addUsingAlias(CustomerTableMap::COL_SITE_ID, $site->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(CustomerTableMap::COL_SITE_ID, $site->toKeyValue('PrimaryKey', 'Id'), $comparison);
    ...
    public function filterByUser($user, ?string $comparison = null)
    {
        if ($user instanceof \Model\User) {
            return $this
                ->addUsingAlias(CustomerTableMap::COL_USER_ID, $user->getId(), $comparison);
            ...
            $this
                ->addUsingAlias(CustomerTableMap::COL_USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
