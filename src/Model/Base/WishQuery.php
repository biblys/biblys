 ...
 *
 * @method     ChildWishQuery leftJoinAxysUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the AxysUser relation
 * @method     ChildWishQuery rightJoinAxysUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AxysUser relation
 * @method     ChildWishQuery innerJoinAxysUser($relationAlias = null) Adds a INNER JOIN clause to the query using the AxysUser relation
 *
 * @method     ChildWishQuery joinWithAxysUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AxysUser relation
 *
 * @method     ChildWishQuery leftJoinWithAxysUser() Adds a LEFT JOIN clause and with to the query using the AxysUser relation
 * @method     ChildWishQuery rightJoinWithAxysUser() Adds a RIGHT JOIN clause and with to the query using the AxysUser relation
 * @method     ChildWishQuery innerJoinWithAxysUser() Adds a INNER JOIN clause and with to the query using the AxysUser relation
 *
