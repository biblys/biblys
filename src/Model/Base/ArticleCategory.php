...
abstract class ArticleCategory implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\ArticleCategoryTableMap';
     ...
     * @return $this|\Model\ArticleCategory The current object (for fluent API support)
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\ArticleCategory
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\ArticleCategory The current object, for fluid interface
     */
     ...
     *
     * @return     $this|ChildArticleCategory The current object (for fluent API support)
     */
