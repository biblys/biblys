...
abstract class InventoryItemQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_ID, $id, $comparison);
    }
    ...
    public function filterByInventoryId($inventoryId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_INVENTORY_ID, $inventoryId, $comparison);
    }
    ...
    public function filterByEan($ean = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_EAN, $ean, $comparison);
    }
    ...
    public function filterByQuantity($quantity = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_QUANTITY, $quantity, $comparison);
    }
    ...
    public function filterByStock($stock = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_STOCK, $stock, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_CREATED, $createdAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_UPDATED, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(InventoryItemTableMap::COL_II_UPDATED);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(InventoryItemTableMap::COL_II_UPDATED);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(InventoryItemTableMap::COL_II_CREATED);
    }
    ...
    {
        return $this->addUsingAlias(InventoryItemTableMap::COL_II_CREATED, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(InventoryItemTableMap::COL_II_CREATED);
    }
