 ...
 *
 * @method     \Model\AxysAccountQuery|\Model\SiteQuery|\Model\PublisherQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class RightQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT right_id, right_uid, axys_account_id, site_id, publisher_id, bookshop_id, library_id, right_current, right_created, right_updated FROM rights WHERE right_id = :p0';
        try {
