...
abstract class Wishlist implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\WishlistTableMap';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WishlistTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Wishlist The current object, for fluid interface
     */
